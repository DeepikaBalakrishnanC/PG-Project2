...
INSERT INTO `chat` (`chat_id`, `friend_id`, `user_id`, `chat`, `photo`, `date`, `time`) VALUES
(1, 2, 1, 'hey', NULL, '2021-12-08', '11:58:19'),
(2, 1, 2, 'hello', NULL, '2021-12-08', '12:00:01'),
(3, 1, 3, 'good mornin', NULL, '2021-12-09', '10:44:45'),
(4, 3, 1, 'mornin mornin', NULL, '2021-12-09', '10:52:40'),
(5, 3, 5, 'hellooooo', NULL, '2021-12-09', '11:01:40'),
(6, 9, 3, 'hello', NULL, '2022-03-03', '02:00:23');
...
--
ALTER TABLE `friends`
  MODIFY `friend_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
